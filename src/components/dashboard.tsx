  ...
  return (
    <section className="p-6">
      ...
      <div className="flex flex-col justify-center items-center w-full mt-8">
        ...
        <p className="font-bold text-lg text-[#434343]">
          Mau ngapain hari ini?
        </p>
        <div className="flex flex-row w-full justify-between gap-4 mt-4">
          <Link
            href={"/booking"}
            className="flex flex-1 border rounded-full py-2 justify-center items-center font-ligth text-xs text-[#434343] border-[#D9F1EA]"
          >
            Booking Lapangan
          </Link>
          <Link
